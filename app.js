...
// ------------------------------------------
// 🌬️ Windy 氣象圖：一律用 HTML 內寫死的台灣中心 zoom 3 預設，不再做定位
// ------------------------------------------
...
// ==========================================
const coordsDB = {
    "RCTP": [25.0777, 121.2328], "RCSS": [26.5283, 122.0750], "RCKH": [22.5771, 120.3500], "RCMQ": [24.2646, 120.6200], "RCNN": [22.9503, 120.2061], "RCFN": [22.7564, 121.1033],
